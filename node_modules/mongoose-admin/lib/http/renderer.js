...
Renderer.renderDocumentField = function(models, field, fields, options, document, isChild, parentFieldName) {
    ...
    var fieldName = '';
    if (isChild) {
        fieldValue = (document && document[parentFieldName][field]) ? (typeof(document[parentFieldName][field])=="object" ? JSON.stringify(document[parentFieldName][field]) : document[parentFieldName][field].toString()) : '';
        fieldName = parentFieldName + '[' + field + ']';
    } else {
        fieldValue = (document && document[field]) ? (typeof(document[field])=="object" ? JSON.stringify(document[field]) : document[field].toString()) : '';
        fieldName = field;
    }
